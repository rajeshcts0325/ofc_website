                                        ...
                                        <div className="col-lg-12">
                                            <div className="footer-widget-section">
                                                ...
                                                <div className="pera">
                                                    ...
                                                    <p>
                                                        Discover all you need for purchasing, selling, and <br className="d-lg-block d-none" /> renting property with the new
                                                        <span>HouseBox App!</span>
                                                    </p>
                                                </div>
                                                <ul>
                                                    <li>
                                                        <Link href="#">
                                                            <img src="/assets/img/elements/elements7.png" alt="housebox" />
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link href="#">
                                                            <img src="/assets/img/elements/elements8.png" alt="housebox" />
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link href="#">
                                                            <img src="/assets/img/elements/elements9.png" alt="housebox" />
                                                        </Link>
                                                    </li>
                                                </ul>
                                            </div>

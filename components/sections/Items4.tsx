...
export default function Items4() {
    ...
    return (
        <>
            <div className="items4-section-area sp1" style={{ backgroundImage: "url(assets/img/all-images/bg/bg6.png)", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundAttachment: "fixed" }}>
                <div className="container">
                    ...
                    <div className="row">
                        <div className="items-images-area" data-aos="fade-up" data-aos-duration={1000}>
                            <Slider {...settings} className="slider-content-area">
                                <div>
                                    <div className="row">
                                        <div className="col-lg-5">
                                            <div className="img1 image-anime">
                                                <img src="/assets/img/all-images/items/item-img5.png" alt="housebox" />
                                            </div>
                                        </div>
                                        <div className="col-lg-7">
                                            <div className="items-content-area">
                                                ...
                                                <div className="content-area">
                                                    ...
                                                    <Link href="/property-details-v1">Rancho Vista Verde, Santos Barba</Link>
                                                    <div className="space20" />
                                                    <p>
                                                    ...
                                                    <div className="btn-area">
                                                        ...
                                                        <div className="btn-area">
                                                            <Link href="#" className="heart">
                                                                <img src="/assets/img/icons/heart5.svg" alt="housebox" className="heart1" />
                                                                <img src="/assets/img/icons/heart5.svg" alt="housebox" className="heart2" />
                                                            </Link>

...
export default function Hero3() {
    return (
        <>
            <div className="hero3-section-area" style={{ backgroundImage: "url(assets/img/all-images/bg/hero-bg3.png)", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
                ...
                <div className="main-imagesarea">
                    <div className="img1 aniamtion-key-2">
                        <img src="/assets/img/all-images/hero/hero3-img1.png" alt="housebox" />
                    </div>
                    <div className="img2">
                        <img src="/assets/img/elements/bottom-img2.png" alt="housebox" />
                    </div>
                </div>
                <div className="img3">
                    <img src="/assets/img/elements/bottom-img1.png" alt="housebox" />
                </div>
                {/*===== OTHERS AREA STARTS =======*/}
                                        ...
                                        <div className="group-price">
                                            <div className="slider-item">
                                                <div className="slider-label">
                                                    Price Range: <span id="price-output">$200 - $2,500,000</span>
                                                </div>
                                            ...
                                            <div className="slider-item">
                                                <div className="slider-label">
                                                    Size Range: <span id="size-output">146 SqFt - 448 SqFt</span>
                                                </div>
                ...
                <div className="villa-listing">
                    ...
                    <div className="villa-images">
                        <div className="img1">
                            <img src="/assets/img/all-images/others/others-img4.png" alt="housebox" />
                        </div>
                        <div className="text">
                ...
                <div className="villa-listing2">
                    ...
                    <div className="villa-images">
                        <div className="img1">
                            <img src="/assets/img/all-images/others/others-img5.png" alt="housebox" />
                        </div>
                        <div className="text">

                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={800}>
                            <div className="team-single-boxarea">
                                <div className="img1">
                                    <img src="/assets/img/all-images/team/team-img5.png" alt="housebox" />
                                </div>
                                <div className="content-area">
                                    <Link href="#">Robert Henry</Link>
                        ...
                        <div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={900}>
                            <div className="team-single-boxarea">
                                <div className="img1">
                                    <img src="/assets/img/all-images/team/team-img6.png" alt="housebox" />
                                </div>
                                <div className="content-area">
                        ...
                        <div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={1000}>
                            <div className="team-single-boxarea">
                                <div className="img1">
                                    <img src="/assets/img/all-images/team/team-img7.png" alt="housebox" />
                                </div>
                                <div className="content-area">
                                    <Link href="#">Trent Blake</Link>
                                    <div className="space14" />
                                    <p>Tax Analysis</p>
                                    <div className="space32" />
                                    <ul>
                        ...
                        <div className="col-lg-3 col-md-6" data-aos="zoom-in-up" data-aos-duration={1200}>
                            <div className="team-single-boxarea">
                                <div className="img1">
                                    <img src="/assets/img/all-images/team/team-img8.png" alt="housebox" />
                                </div>
                                <div className="content-area">
                                    <Link href="#">Jos Butler</Link>
                                    <div className="space14" />
